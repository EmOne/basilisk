...
Eigen::Vector3d
PointMassGravityModel::computeField(const Eigen::Vector3d& position_planetFixed) const
{
...
double
PointMassGravityModel::computePotentialEnergy(const Eigen::Vector3d& positionWrtPlanet_N) const
{
